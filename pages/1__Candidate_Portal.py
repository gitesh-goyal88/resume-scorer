...
if st.session_state.resume_text:
    if st.button(" Clear & Upload New Resume", type="secondary"):
        keys_to_clear = [
...
if st.session_state.resume_text:
    ...
    view_mode = st.radio("Candidate Hub Mode:", [" VMock Report & Insights", " Interactive Resume Editor"], horizontal=True)
    
    if view_mode == " Interactive Resume Editor":
